...
export default function Page() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className={`w-full min-h-screen bg-white bg-opacity-95 backdrop-filter backdrop-blur-lg py-20 transition-opacity ${isProjectsVisible ? 'opacity-100' : 'opacity-0'}`}
